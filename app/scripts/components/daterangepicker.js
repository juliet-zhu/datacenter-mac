...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.showFromToLabel = true;
        this.showCalendar = true;// 是否显示双日历
        this.customRangeLabel = true;// 是否label标题
        this.customRangeActive = true;// 是否让最后一个选中
        this.ranges = {};
        ...
        if (hasOptions) {
            ...
            if (typeof options.showFromToLabel == 'boolean') {
            	this.showFromToLabel = options.showFromToLabel;
            }
        }

        var DRPTemplate = '<div class="daterangepicker dropdown-menu" data-widget="daterangepicker">' +
                '<div class="calendar left"></div>' +
                '<div class="calendar right"></div>' +
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input" style="float: left">' +
                      '<label for="daterangepicker_start"' + (!this.showFromToLabel ? 'class="sr-only"' : '') + '>' + this.locale.fromLabel + '</label>' +
                      '<input class="input-mini" type="text" name="daterangepicker_start" value="" disabled="disabled" />' +
                    '</div>' +
                    '<div class="daterangepicker_end_input" style="float: left; padding-left: 11px">' +
                      '<label for="daterangepicker_end"' + (!this.showFromToLabel ? 'class="sr-only"' : '') + '>' + this.locale.toLabel + '</label>' +
                      '<input class="input-mini" type="text" name="daterangepicker_end" value="" disabled="disabled" />' +
                    '</div>' +
                    '<div class="ranges_list"> </div>' +
                    '<div class="btn_list"><button class="' + this.applyClass + ' applyBtn" disabled="disabled">' + this.locale.applyLabel + '</button>&nbsp;' +
        ...
        if (hasOptions) {
            ...
            if (typeof options.rangesInsertType == 'string')
            	this.rangesInsertType = options.rangesInsertType;
            
            if (typeof options.customRangeLabel == 'boolean') 
                this.customRangeLabel = options.customRangeLabel;
            
            if (typeof options.customRangeActive == 'boolean') 
            	this.customRangeActive = options.customRangeActive
            ...
            if (typeof options.ranges == 'object') {
                ...
                for (var range in this.ranges) {
                    list += '<li class="li_'+index+'">' + range + '</li>';
                    index ++;
                }
                ...
                */
                // modify date:2013-11-25 author:江闵
                this.container.find('.ranges_list').append(list)
            }
    ...
    DateRangePicker.prototype = {
        ...
        updateCalendars: function () {
            ...
            if (customRange && this.customRangeActive)
